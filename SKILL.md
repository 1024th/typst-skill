...
name: typst
description: |
  Modern Typst typesetting patterns for documents, slides, and academic writing. Use this skill when writing Typst markup, creating document templates, building slide decks with Quarto, or debugging Typst compilation issues. Covers content blocks, styling, math typesetting, tables, figures, custom functions, citations, and Quarto integration.
author: Ulrich Atz
license: CC-BY-4.0
metadata:
  typst_version: "0.13+"
allowed-tools: Read, Edit, Write, Grep, Glob, Bash, mcp__context7__*
---
...
**Related skills:**
- `/touying` - Slide presentations with animations and themes
- `/write-cetz` - Diagrams, flowcharts, plots (TikZ-style drawing)
...
- Slide presentations with animations → use `/touying`
- Diagrams or flowcharts → use `/write-cetz`
